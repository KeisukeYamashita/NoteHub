...
class NoteHubController extends Controller
{
    ...
    public function channel() {
      ...
      if ($dt->between(Carbon::createFromTime(14,55,0,$tz), Carbon::createFromTime(16,50,0,$tz))) $period = 3;
      if ($dt->between(Carbon::createFromTime(16,50,0,$tz), Carbon::createFromTime(18,35,0,$tz))) $period = 3;
